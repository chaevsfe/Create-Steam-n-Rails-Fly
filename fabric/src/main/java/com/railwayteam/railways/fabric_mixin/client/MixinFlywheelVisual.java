...
/** Selects the locometal wheel partial for block-entity Flywheel visuals. */
@Mixin(value = FlywheelVisual.class, remap = false)
public abstract class MixinFlywheelVisual {
    @WrapOperation(
        method = "<init>",
        at = @At(
            value = "FIELD",
