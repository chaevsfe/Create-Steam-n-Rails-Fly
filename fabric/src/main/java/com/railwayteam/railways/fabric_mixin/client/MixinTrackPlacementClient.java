...
@Mixin(value = TrackPlacementClient.class, remap = false)
public class MixinTrackPlacementClient {
    @WrapOperation(method = "clientTick", constant = @Constant(classValue = TrackBlock.class))
    private static boolean railways$treatCrossingAsTrack(Object object, Operation<Boolean> original) {
