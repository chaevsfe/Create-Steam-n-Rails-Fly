...
import com.railwayteam.railways.shim.registrate.providers.ProviderType;
...
public class BlockBuilder<T extends Block, P> extends AbstractBuilder<T, P, BlockBuilder<T, P>> {
    ...
    public BlockBuilder<T, P> loot(NonNullBiConsumer<? super com.railwayteam.railways.shim.registrate.providers.loot.RegistrateBlockLootTables, ? super T> consumer) {
        return this;
    }
