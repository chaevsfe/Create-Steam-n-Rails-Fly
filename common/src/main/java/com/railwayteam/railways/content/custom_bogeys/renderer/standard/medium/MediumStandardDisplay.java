...
public class MediumStandardDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public MediumStandardDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_STANDARD_FRAME);
