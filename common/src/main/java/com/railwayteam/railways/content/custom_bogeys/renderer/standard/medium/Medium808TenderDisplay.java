...
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_8_0_8_TENDER_FRAME;
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_SHARED_WHEELS;

public class Medium808TenderDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public Medium808TenderDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_8_0_8_TENDER_FRAME);
