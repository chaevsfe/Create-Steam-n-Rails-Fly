...
public class MediumSingleWheelDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?> wheels;
    private final Affine<?>[] secondaryShafts;

    public MediumSingleWheelDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_SINGLE_WHEEL_FRAME);
