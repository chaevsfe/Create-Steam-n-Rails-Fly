...
public class RadialBogeyDisplay extends TripleAxleBogeyDisplay {
    public RadialBogeyDisplay(ElementProvider<?> prov) {
        super(prov, RADIAL_FRAME, AllPartialModels.SMALL_BOGEY_WHEELS, false);
    }
}
