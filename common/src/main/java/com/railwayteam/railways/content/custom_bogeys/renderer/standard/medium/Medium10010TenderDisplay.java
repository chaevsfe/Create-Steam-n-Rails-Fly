...
public class Medium10010TenderDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public Medium10010TenderDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_10_0_10_TENDER_FRAME);
