...
public class ArchbarBogeyDisplay extends CrossShaftDoubleAxleBogeyDisplay {
    public ArchbarBogeyDisplay(ElementProvider<?> prov) {
        super(prov, ARCHBAR_FRAME, AllPartialModels.SMALL_BOGEY_WHEELS, false);
    }
}
