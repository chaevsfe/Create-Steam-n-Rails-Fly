...
package com.railwayteam.railways.content.custom_bogeys.renderer.standard.triple_axle.base;
...
public class TripleAxleBogeyDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] shafts;
    private final float finalTranslateY;

    public TripleAxleBogeyDisplay(ElementProvider<?> prov, PartialModel frame, PartialModel wheels, boolean recenterWheels) {
        this.frame = prov.create(frame);
        this.wheels = prov.create(wheels, 3);
