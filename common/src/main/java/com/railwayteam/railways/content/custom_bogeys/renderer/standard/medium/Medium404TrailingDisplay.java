...
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_4_0_4_TRAILING_FRAME;
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_SHARED_WHEELS;

public class Medium404TrailingDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public Medium404TrailingDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_4_0_4_TRAILING_FRAME);
        wheels = prov.create(MEDIUM_SHARED_WHEELS, 2);
