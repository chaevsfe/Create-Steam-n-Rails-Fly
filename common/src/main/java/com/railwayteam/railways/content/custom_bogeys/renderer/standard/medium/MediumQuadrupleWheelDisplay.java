...
public class MediumQuadrupleWheelDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public MediumQuadrupleWheelDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_QUADRUPLE_WHEEL_FRAME);
