...
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_6_0_6_TENDER_FRAME;
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_SHARED_WHEELS;

public class Medium606TenderDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public Medium606TenderDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_6_0_6_TENDER_FRAME);
