...
import static com.railwayteam.railways.registry.CRBlockPartials.MEDIUM_TRIPLE_WHEEL_FRAME;

public class MediumTripleWheelDisplay implements BogeyDisplay {
    private final Affine<?> frame;
    private final Affine<?>[] wheels;
    private final Affine<?>[] secondaryShafts;

    public MediumTripleWheelDisplay(ElementProvider<?> prov) {
        frame = prov.create(MEDIUM_TRIPLE_WHEEL_FRAME);
