...
sourceSets {
    main {
        ...
        java.exclude(
            ...
            "com/railwayteam/railways/mixin/AccessorTrackMaterialFactory.java",
            "com/railwayteam/railways/mixin/AccessorTrainRelocator.java",
            "com/railwayteam/railways/mixin/compat/malilib/**",
